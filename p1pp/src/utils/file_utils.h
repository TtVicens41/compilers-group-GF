 ...
 * a path, or both input and output paths, as parameters. The main logic is
 * to read from that input path, and wirte content to that output path.
 ...
 * @param file_path File path to be printed.
 */
